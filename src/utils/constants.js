...
export const API_SEARCH_MOVIE = `https://api.themoviedb.org/3/search/movie?api_key=${API_KEY}&language=pt-BR&page=1`;
...
export const MOVIE_GENRE = ['Mais Recente', 'Ação', 'Aventura', 'Ficção', 'Mistério'];